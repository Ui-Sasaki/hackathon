...
export default function HelperProfileScreen() {
  ...
  const [helperType, setHelperType] =
    useState<HelperType>(null);
          ...
          <View style={styles.form}>
            ...
            <View style={styles.notesSection}>
              ...
              <TextInput
                ...
                placeholder="サポートを受ける人に知っておいてほしいこと"
