...
from app.repositories.blocks import BlockRepository, get_block_repository
...
async def block_repository_dependency() -> BlockRepository:
    """Resolve the configured user-block repository."""

    return get_block_repository()
